...
$row = mysql_fetch_assoc(mysql_query("SELECT *  FROM internet_shop"));
...
<body>
	<div class="header">
				...
				<div class="header_top">
					<div class="logo">
						<a href="index.html"><img src="images/cv.png" alt="" /></a>
					</div>
   	 ...
   	 <div class="wrap">
   	 	<div class="preview-page">
					...
					<div class="grid images_3_of_2">
							...
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/uspolo.jpg" />
									<img class="etalage_source_image" src="images/uspolo.jpg" title="" />
								</a>
							</li>
							<li>
							...
							<li>
								<img class="etalage_thumb_image" src="images/redpolo.jpg" />
								<img class="etalage_source_image" src="images/redpolo.jpg" />
							</li>
						</ul>
				     </div>
				   <div class="desc span_3_of_2">
					<h2>Whirlpool LAVADORA   LTE5243D 3.4 CuFt.... </h2>
					<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>					
					<div class="price">
						<p>Price: <span><?php  echo $relojt;?></span></p>
					</div>
					<div class="available">
						<ul>
						  <li><span>Model:</span> &nbsp; Model 1</li>
						  <li><span>Shipping Weight:</span>&nbsp; 75.58 kg</li>
						  <li><span>Units in Stock:</span><?php  echo $stock;?></li>
					    </ul>
					</div>
				<div class="share-desc">
					...
					<div class="button"><span><a href="carshop/demo.php">Add to Cart</a></span></div>					
					<div class="clear"></div>
				</div>
				 <div class="wish-list">
				 	<ul>
				 ...
				 <div class="colors-share">
				 	<div class="color-types">
				 		...
				 		<form class="checkbox-buttons">
							<ul>
								<li><input id="r1" name="r1" type="radio"><label for="r1" class="red"> </label></li>
